...
- Infrastructure as Code (Terraform beginner)
...
- Improving CI/CD automation skills
- Preparing for **cloud & DevOps internship** opportunities

## 📂 Projects I'm Working On

- Kubernetes practice labs
- AWS cloud mini-projects (S3, Lambda, IAM, API Gateway)
